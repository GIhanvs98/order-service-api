package com.gihanvs.quickcart.order_service_api.api;
...
public class CustomerOrderController {
    ...
    public ResponseEntity<StandardResponseDto> create(@RequestBody CustomerOrderRequestDto request) {
        ...
        return new ResponseEntity<>(
                new StandardResponseDto(201, "customer order has been created", null),
                HttpStatus.CREATED
        );
    }
    ...
    public ResponseEntity<StandardResponseDto> findById(@PathVariable String id) {
        return new ResponseEntity<>(
                new StandardResponseDto(200, "customer order details", customerOrderService.findOrderById(id)),
                HttpStatus.OK
        );
    }
    ...
    public ResponseEntity<StandardResponseDto> updateOrder(@RequestBody CustomerOrderRequestDto request, @PathVariable String id) {
        ...
        return new ResponseEntity<>(
                new StandardResponseDto(200, "customer order has been updated", null),
                HttpStatus.OK
        );
    }
    ...
    public ResponseEntity<StandardResponseDto> deleteById(@PathVariable String id) {
        ...
        return new ResponseEntity<>(
                new StandardResponseDto(204, "customer order has been deleted", null),
    ...
    public ResponseEntity<StandardResponseDto> searchAll(@RequestParam String searchText, @RequestParam int page, @RequestParam int size) {
        return new ResponseEntity<>(
                new StandardResponseDto(200, "customer order list", customerOrderService.searchAll(searchText, page, size)),
                HttpStatus.OK
        );
    }
}
